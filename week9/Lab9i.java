...
public class Lab9iStartCode {
	...
	public static int getValidInt(Scanner sIn, String question, String warning, int[] range)
	{
		...
		do
		{
			...
			try 
			{
				validInt = Integer.parseInt(response);
				if(range.length != 0)
				{
					if(validInt >= range[0] && range[1] >= validInt)
					{
						done = true;
					}else
					{
	...
	public static double getValidDouble(Scanner sIn, String question, String warning, double[] range)
	{
		...
		do
		{
			...
			try 
			{
				validDouble = Double.parseDouble(response);
				if(range.length != 0)
				{
					if(validDouble >= range[0] && range[1] >= validDouble)
					{
						done = true;
					}else
					{
	...
	public static String getValidString(Scanner sIn, String question, String warning, String[] choices)
	{
		...
		do 
		{
			...
			}else
			{
				...
				{
					if(choices[i].equalsIgnoreCase(response))
					{
						match = true;
					}else
					{
